# -*- coding: utf-8 -*-
"""
Created on Tue Feb  2 22:14:11 2021
...
df1=pd.read_html(link_2019,header=0)[2]
df2=pd.read_html(link_2019,header=0)[3]
df3=pd.read_html(link_2019,header=0)[4]
df4=pd.read_html(link_2019,header=0)[5]
...
df_19=df.loc[:,['director_name','actor_1_name','actor_2_name','actor_3_name','genres','movie_title']]

df_19.isna().sum()

df_19['actor_2_name']=df['actor_2_name'].replace(np.nan,'unknown')
df_19['actor_3_name']=df['actor_3_name'].replace(np.nan,'unknown')

df_19['movie_title']=df_19['movie_title'].str.lower()

df_19['combo']=df_19['actor_1_name']+" "+df_19['actor_2_name']+" "+df_19['actor_3_name']+" "+df_19['director_name']+" "+df_19['genres']

old=pd.read_csv('../datasets/dataupto18.csv')

new_data=old.append(df_19)

new_data.to_csv('../datasets/dataupto19.csv',index=False)
